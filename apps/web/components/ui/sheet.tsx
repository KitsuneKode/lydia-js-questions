...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-xl border-t border-border bg-surface',
        className,
      )}
      {...props}
    >
      <div className="mx-auto mt-4 h-1 w-12 rounded-full bg-border-strong" />
      {children}
    </DrawerPrimitive.Content>
  </SheetPortal>
));
