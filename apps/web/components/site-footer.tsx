...
const footerLinks = {
  ...
  resources: [
    { href: 'https://github.com/lydiahallie/javascript-questions', label: 'Original Repository', external: true },
    { href: 'https://github.com/lydiahallie', label: 'Lydia Hallie', external: true },
  ],
};
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2 font-display text-lg font-medium text-foreground">
              JS Interview Atlas
            </Link>
            <p className="mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
              An open-source JavaScript interview practice platform. Built with respect for the original content creators and the learning community.
            </p>
            ...
            <ul className="mt-3 space-y-2">
              {footerLinks.resources.map((link) => (
                <li key={link.href}>
                  ...
                  >
                    {link.label}
                    {link.external && <Github className="h-3 w-3" />}
                  </Link>
                </li>
              ))}
            </ul>
